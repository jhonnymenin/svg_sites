...
const BRANDS = [
  ...
  { name: "Saudades", img: "/food/cheesebread.jpg", pos: "30% 92%" },
      ...
      <Rail title="Food + Drink" index={1} cta={{ label: "View All Brands", href: "#" }} tone="light">
        {BRANDS.map(({ name, img, pos }, i) => (
          <a
            ...
            data-rail-card
            href="#"
            className="group w-[210px] shrink-0 [scroll-snap-align:start] sm:w-[230px] md:w-[250px]"
          >
            <div
            ...
            >
              ...
              />
              <span className="absolute left-0 top-0 flex h-8 w-8 items-center justify-center bg-cream font-display text-[12px] font-bold text-ink">
            ...
            <div className="mt-2.5 flex items-start justify-between gap-2 border-t border-ink/12 pt-2">
              ...
              <span aria-hidden className="mt-1 shrink-0 text-rust opacity-0 transition-opacity duration-150 group-hover:opacity-100">
                →
              </span>
            </div>
          </a>
